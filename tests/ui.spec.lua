...
test("controls use border strokes, drawn disclosures, public navigation images and avatar thumbnails", function()
	...
	local icon = window._tabsByName.Library.IconLabel:FindFirstChild("NavigationIcon_library")
	assert(icon and icon:IsA("ImageLabel") and icon.Image == "rbxassetid://7743869054")
