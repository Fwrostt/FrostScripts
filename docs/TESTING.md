...
Run `python tools/build.py` and `python tools/check.py`. The suite compiles distributable code and the gallery, then runs **10 API**, **15 UI**, and **4 launcher integration** tests against mocked HTTPS and Roblox services. It does not render Roblox or simulate the game servers.
